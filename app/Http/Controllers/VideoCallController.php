...
{
    public function requestVideoCall(Request $request, User $user): \Illuminate\Http\JsonResponse
    {
    ...
    public function requestVideoCallStatus(Request $request, User $user): \Illuminate\Http\JsonResponse
    {
        $user->peerId = $request->peerId;
        $user->fromUser = Auth::user();
